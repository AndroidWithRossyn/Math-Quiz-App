...
public class QuizHelper extends SQLiteOpenHelper {
    ...
    public void deleteTable() {
        if (dbase == null || !dbase.isOpen()) dbase = getWritableDatabase();
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "CREATE TABLE IF NOT EXISTS " + TABLE_QUEST + " ( " + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_QUES + " TEXT, " + KEY_ANSWER + " TEXT, " + KEY_OPTA + " TEXT, " + KEY_OPTB + " TEXT, " + KEY_OPTC + " TEXT, " + KEY_TYPE + " TEXT)";
        db.execSQL(sql);
        addQuestion();
        // db.close();
    }
    ...
    private void addQuestionaddition() {
        ...
        for (int i = 0; i < Constant.questions_number; i++) {
            ...
            if (optionone == anwsr) optionone += rand.nextInt(3);
            if (optiontow == anwsr) optiontow += rand.nextInt(3);
            if (optionone == optiontow) optiontow += rand.nextInt(3);
